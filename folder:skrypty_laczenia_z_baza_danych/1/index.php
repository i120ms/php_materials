...
<div class="form-container">
    ...
    <?php
        ...
        if($pol && isset($_POST['nazwa'],$_POST['cena'],$_POST['promocja'],$_POST['idDostawcy'])){
        ...
        if($pol){
            $zapy = "SELECT COUNT(*) FROM towary";
            $wynikzapy = mysqli_query($pol, $zapy);
            $ile = mysqli_fetch_row($wynikzapy);
            if($ile){
                echo $ile[0];
            }
        }
